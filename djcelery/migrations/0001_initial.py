# -*- coding: utf-8 -*-
# Generated by Django 1.9.7 on 2016-07-26 02:24
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='Useful description', max_length=191, unique=True, verbose_name='name')),
                ...
                ('queue', models.CharField(blank=True, default=None, help_text='Queue defined in CELERY_QUEUES', max_length=191, null=True, verbose_name='queue')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('taskset_id', models.CharField(max_length=191, unique=True, verbose_name='group id')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('state', models.CharField(choices=[(b'RECEIVED', b'RECEIVED'), (b'RETRY', b'RETRY'), (b'REVOKED', b'REVOKED'), (b'SUCCESS', b'SUCCESS'), (b'STARTED', b'STARTED'), (b'FAILURE', b'FAILURE'), (b'PENDING', b'PENDING')], db_index=True, max_length=64, verbose_name='state')),
                ('task_id', models.CharField(max_length=36, unique=True, verbose_name='UUID')),
                ('name', models.CharField(db_index=True, max_length=191, null=True, verbose_name='name')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('hostname', models.CharField(max_length=191, unique=True, verbose_name='hostname')),
